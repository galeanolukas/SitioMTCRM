...
def get_default_database():
    ...
    if ENVIRONMENT == 'production':
        ...
        return {
            ...
            'NAME': os.getenv('DB_NAME', 'crm_multilideres_db'),
            'USER': os.getenv('DB_USER', 'crm_multilideres'),
            'PASSWORD': os.getenv('DB_PASSWORD', 'Mult1l1d3r3$'),
...
def get_remote_database():
    ...
    return {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('REMOTE_DB_NAME', 'crm_multilideres_db'),
        'USER': os.getenv('REMOTE_DB_USER', 'crm_multilideres'),
        'PASSWORD': os.getenv('REMOTE_DB_PASSWORD', 'Mult1l1d3r3$'),
        'HOST': os.getenv('REMOTE_DB_HOST', 'www.multilideres.com'),
